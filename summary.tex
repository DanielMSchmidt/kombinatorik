...
\section*{Seminar Kombinatorik: Turáns Graphtheorem}
\end{minipage}
\end{center}
...
Im Folgenden werde ich zunächst Definitionen für die in den Beweisen verwendeten Begriffe liefern, danach werde ich die drei Beweisen vorstellen, welche den Kern dieser Ausarbeitung bilden. \\
