...
\fancyhf{}
\fancyhead[L]{
\headerleftright{\textbf{Turans Graphtheorem}}{Daniel Schmidt}}
\fancyfoot[C]{\thepage}
...
\chapter{Einleitung}
\label{introduction:einleitung}\label{introduction::doc}\label{introduction:turans-graph-theorem}

\chapter{Das Theorem}
\label{theorem:das-theorem}\label{theorem::doc}

\section{Umgangssprachlich}
\label{theorem:umgangssprachlich}
...
\section{Turáns Graphtheorem}
\label{theorem:turans-graphtheorem}
Turáns Graphtheorem besagt, dass für einen Graph G = (V,E) mit n Knoten ohne p-Clique gilt:
\begin{gather}
\begin{split}\mid E \mid \le (1- \frac{1}{p-1}) \frac{n^2}{2}\end{split}\notag\\\begin{split}\end{split}\notag
\end{gather}
